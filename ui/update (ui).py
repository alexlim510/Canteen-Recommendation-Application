...
def add_canteen(canteendata):
    ...
    Button(ac_screen, text="submit", command=lambda:obtain_canteen_ac(canteendata, canteen)).grid(row=0,column=2)


def obtain_canteen_ac(canteendata, canteen):
    canteen = canteen.get()
    ac_f2 = Toplevel()
    msg_ac = StringVar()
...
def add_booth(canteendata):
    ...
    canteen.grid(row=0,column=1)
    Button(ab_screen, text="submit", command=lambda:obtain_canteen_ab(canteendata, canteen)).grid(row=0,column=2)

def obtain_canteen_ab(canteendata, canteen):
    canteen = canteen.get()
    ab_f2 = Toplevel()
    msg_ab1 = StringVar()
    ...
    if check_canteen(canteendata, canteen):
        ...
        Button(ab_f2, text="submit", command=lambda:obtain_booth_ab(canteendata,canteen, booth)).grid(row=0,column=2)
    else:
        msg_ab1.set("Please input a valid canteen.")

#retrieve and check booth
def obtain_booth_ab(canteendata, canteen, booth):
    booth = booth.get()
    ab_f3 = Toplevel()
    msg_ab2 = StringVar()
...
def add_food(canteendata):
    ...
    canteen.grid(row=0,column=1)
    Button(af_screen, text="submit", command=lambda:obtain_canteen_af(canteendata,canteen)).grid(row=0,column=2)


def obtain_canteen_af(canteendata, canteen):
    canteen = canteen.get()
    af_f2 = Toplevel()
    msg_af1 = StringVar()
    ...
    if check_canteen(canteendata, canteen):
        if any(canteendata['canteen'][canteen]['booths'].items()):
            ...
            booth = Entry(af_f2)
            booth.grid(row=0,column=1)
            Button(af_f2, text="submit", command=lambda:obtain_booth_af(canteendata,canteen, booth)).grid(row=0,column=2)
        else:
            msg_af1.set("This canteen does not have booth.")
    else:
        msg_af1.set("Please input a valid canteen.")

def obtain_booth_af(canteendata, canteen, booth):
    booth = booth.get()
    af_f3 = Toplevel()
    msg_af3 = StringVar()
    ...
    if check_booth(canteendata, canteen, booth):
        ...
        Button(af_f3, text="submit", command=lambda:obtain_food_af(canteendata,canteen,booth,food)).grid(row=0,column=2)
    else:
        msg_af3.set("Please input a valid booth.")

def obtain_food_af(canteendata, canteen, booth,food):
    food = food.get()
    af_f4 = Toplevel()
    msg_af4 = StringVar()
    ...
    if check_food(canteendata, canteen, booth, food):
        ...
        Button(af_f4, text="submit", command=lambda:obtain_price_af(canteendata,canteen,booth,food,price)).grid(row=0,column=2)


def obtain_price_af(canteendata, canteen, booth, food, price):
    price = price.get()
    af_f5 = Toplevel()
    msg_af5 = StringVar()
...
def change_price(canteendata):
    ...
    canteen.grid(row=0,column=1)
    Button(cp_screen, text="submit", command=lambda:obtain_canteen_pc(canteendata,canteen)).grid(row=0,column=2)

def obtain_canteen_pc(canteendata, canteen):
    canteen = canteen.get()
    cp_f2 = Toplevel()
    msg_cp1 = StringVar()
    ...
    if check_canteen(canteendata, canteen):
        if any(canteendata['canteen'][canteen]['booths'].items()):
            ...
            booth = Entry(cp_f2)
            booth.grid(row=0,column=1)
            Button(cp_f2, text="submit", command=lambda:obtain_booth_pc(canteendata,canteen, booth)).grid(row=0,column=2)
        else:
            msg_cp1.set("This canteen does not have booth.")
    else:
        msg_cp1.set("Please input a valid canteen.")

def obtain_booth_pc(canteendata, canteen, booth):
    booth = booth.get()
    cp_f3 = Toplevel()
    msg_cp3 = StringVar()
    ...
    if check_booth(canteendata, canteen, booth):
        if any(canteendata['canteen'][canteen]['booths'][booth].items()):
            ...
            food = Entry(cp_f3)
            food.grid(row=0,column=1)
            Button(cp_f3, text="submit", command=lambda:obtain_food_pc(canteendata,canteen,booth,food)).grid(row=0,column=2)
        else:
            msg_cp3.set("This booth does not have food.")
    else:
        msg_cp3.set("Please input a valid booth.")

def obtain_food_pc(canteendata, canteen, booth,food):
    food = food.get()
    cp_f4 = Toplevel()
    msg_cp4 = StringVar()
    ...
    if check_food(canteendata, canteen, booth, food):
        ...
        price = Entry(cp_f4)
        price.grid(row=0,column=1)
        Button(cp_f4, text="submit", command=lambda:obtain_price_pc(canteendata,canteen,booth,food,price)).grid(row=0,column=2)
    else:
        msg_cp4.set("This food does not exist.")


def obtain_price_pc(canteendata, canteen, booth, food, price):
    price = price.get()
    cp_f5 = Toplevel()
    msg_cp5 = StringVar()
...
def add_change_address(canteendata):
    ...
    canteen.grid(row=0,column=1)
    Button(aa_screen, text="submit", command=lambda:obtain_address_aa(canteendata,canteen)).grid(row=0,column=2)

def obtain_address_aa(canteendata, canteen):
    canteen = canteen.get()
    aa_f2 = Toplevel()
    msg_aa1 = StringVar()
    ...
    if check_canteen(canteendata, canteen):
            ...
            Button(aa_f2, text="submit", command=lambda:obtain_address_aa(canteendata,canteen, address)).grid(row=0,column=2)
    else:
        msg_aa1.set("Please input a valid canteen.")


def obtain_address_aa(canteendata, canteen, address):
    address = address.get()
    aa_f3 = Toplevel()
...
def obtain_rank(canteendata, canteen):
    ...
    if check_canteen(canteendata, canteen):
            ...
            Button(ar_f2, text="submit", command=lambda:obtain_rank_ar(canteendata,canteen, rank)).grid(row=0,column=2)
    else:
        msg_ar1.set("Please input a valid canteen.")


def obtain_rank_ar(canteendata, canteen, rank):
    rank = rank.get()
    ar_f3 = Toplevel()
...
def remove_canteen():
    ...
    canteen.grid(row=0,column=1)
    Button(rc_screen, text="submit", command=lambda:obtain_canteen_cr(canteendata, canteen)).grid(row=0,column=2)


#obtain canteen to remove
def obtain_canteen_cr(canteendata, canteen):
    canteen = canteen.get()
    rc_f2 = Toplevel()
    msg_rc = StringVar()
...
def remove_booth():
    ...
    canteen.grid(row=0,column=1)
    Button(rb_screen, text="submit", command=lambda:obtain_canteen_br(canteendata,canteen)).grid(row=0,column=2)


def obtain_canteen_br(canteendata, canteen):
    canteen = canteen.get()
    rb_f2 = Toplevel()
    msg_rb1 = StringVar()
    ...
    if check_canteen(canteendata, canteen):
        if any(canteendata['canteen'][canteen]['booths'].values()):
            ...
            booth = Entry(rb_f2)
            booth.grid(row=0,column=1)
            Button(rb_f2, text="submit", command=lambda:obtain_booth_br(canteendata,canteen,booth)).grid(row=0,column=2)
        else:
...
def obtain_booth_br(canteendata, canteen, booth):
    booth = booth.get()
    rb_f3 = Toplevel()
    msg_rb2 = StringVar()
...
def remove_food():
    ...
    canteen.grid(row=0,column=1)
    Button(rf_screen, text="submit", command=lambda:obtain_canteen_fr(canteendata,canteen)).grid(row=0,column=2)


def obtain_canteen_fr(canteendata, canteen):
    canteen = canteen.get()
    rf_f2 = Toplevel()
    msg_rf1 = StringVar()
    ...
    if check_canteen(canteendata, canteen):
        if any(canteendata['canteen'][canteen]['booths'].values()):
            ...
            booth = Entry(rf_f2)
            booth.grid(row=0,column=1)
            Button(rf_f2, text="submit", command=lambda:obtain_booth_fr(canteendata,canteen, booth)).grid(row=0,column=2)
        else:
...
def obtain_booth_fr(canteendata, canteen, booth):
    booth = booth.get()
    rf_f3 = Toplevel()
    msg_rf3 = StringVar()
    ...
    if check_booth(canteendata, canteen, booth):
        if any(canteendata['canteen'][canteen]['booths'][booth].values()):
            ...
            food = Entry(rf_f3)
            food.grid(row=0,column=1)
            Button(rf_f3, text="submit", command=lambda:obtain_food_fr(canteendata,canteen,booth,food)).grid(row=0,column=2)
        else:
...
def obtain_food_fr(canteendata, canteen, booth, food):
    food = food.get()
    rf_f4 = Toplevel()
    msg_rf3 = StringVar()
