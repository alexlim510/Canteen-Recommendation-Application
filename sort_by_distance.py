...
dic_canteens = canteendata['canteen']
num_of_canteens = len(canteens)
for canteen in dic_canteens:
    print(canteen, dic_canteens[canteen]['gps coordinates'])  #['gps coordinates'])